...
export class ResultComponent {
	...
	setFilenameAndFetchImages() {
		...
		this.service.getTestScreenshotImageUrl(imageFilename).then(url => {
			this.testImageUrl = url;
			this._changeDetectorRef.markForCheck();
		});
		this.service.getDiffScreenshotImageUrl(imageFilename).then(url => {
			this.diffImageUrl = url;
			this._changeDetectorRef.markForCheck();
		});
		this.service.getGoldScreenshotImageUrl(imageFilename).then(url => {
