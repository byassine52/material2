...
import { CanColor, CanDisableRipple, mixinColor, mixinDisableRipple, ThemePalette } from '@angular/material/core';
...
export class MatTabGroup extends _MatTabGroupMixinBase
	...
	get _dynamicHeightDeprecated(): boolean {
		return this._dynamicHeight;
	}
	set _dynamicHeightDeprecated(value: boolean) {
	...
	private _subscribeToTabLabels() {
		...
		this._tabLabelSubscription = merge(
			...
			...this._tabs.map(tab => tab._labelChange)
		).subscribe(() => {
			this._changeDetectorRef.markForCheck();
		});
	}
