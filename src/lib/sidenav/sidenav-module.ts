...
@NgModule({
	imports: [CommonModule, MatCommonModule, A11yModule, OverlayModule, ScrollDispatchModule, PlatformModule],
	exports: [
		MatCommonModule,
		MatDrawer,
		MatDrawerContainer,
	...
	providers: [{ provide: MAT_DRAWER_DEFAULT_AUTOSIZE, useValue: false }]
})
