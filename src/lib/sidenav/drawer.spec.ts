...
describe('MatDrawer', () => {
	...
	describe('methods', () => {
		...
		it(
			'should resolve the open method promise with an object',
			fakeAsync(() => {
				const fixture = TestBed.createComponent(BasicTestApp);
				fixture.detectChanges();
				const drawer = fixture.debugElement.query(By.directive(MatDrawer));
		...
		it(
			'should resolve the close method promise with an object',
			fakeAsync(() => {
				const fixture = TestBed.createComponent(BasicTestApp);
				fixture.detectChanges();
				const drawer = fixture.debugElement.query(By.directive(MatDrawer));
		...
		it(
			'should be able to close while the open animation is running',
			fakeAsync(() => {
				const fixture = TestBed.createComponent(BasicTestApp);
				fixture.detectChanges();
		...
		it(
			'does not throw when created without a drawer',
			fakeAsync(() => {
				expect(() => {
		...
		it(
			'should emit the backdropClick event when the backdrop is clicked',
			fakeAsync(() => {
				let fixture = TestBed.createComponent(BasicTestApp);
				fixture.detectChanges();
		...
		it(
			'should close when pressing escape',
			fakeAsync(() => {
				let fixture = TestBed.createComponent(BasicTestApp);
		...
		it(
			'should fire the open event when open on init',
			fakeAsync(() => {
		...
		it(
			'should not close by pressing escape when disableClose is set',
			fakeAsync(() => {
				let fixture = TestBed.createComponent(BasicTestApp);
		...
		it(
			'should not close by clicking on the backdrop when disableClose is set',
			fakeAsync(() => {
				let fixture = TestBed.createComponent(BasicTestApp);
				let testComponent = fixture.debugElement.componentInstance;
		...
		it(
			'should restore focus on close if focus is inside drawer',
			fakeAsync(() => {
				let fixture = TestBed.createComponent(BasicTestApp);
				...
				expect(document.activeElement).toBe(openButton, 'Expected focus to be restored to the open button on close.');
			})
		);

		it(
			'should not restore focus on close if focus is outside drawer',
			fakeAsync(() => {
				let fixture = TestBed.createComponent(BasicTestApp);
				let drawer: MatDrawer = fixture.debugElement.query(By.directive(MatDrawer)).componentInstance;
				let openButton = fixture.componentInstance.openButton.nativeElement;
	...
	describe('attributes', () => {
		...
		it('should remove align attr from DOM', () => {
			...
			expect(drawerEl.hasAttribute('align')).toBe(false, 'Expected drawer not to have a native align attribute.');
		});

		it(
			'should throw when multiple drawers have the same position',
			fakeAsync(() => {
		...
		it(
			'should not throw when a two-way binding is toggled quickly while animating',
			fakeAsync(() => {
	...
	describe('focus trapping behavior', () => {
		...
		it(
			'should trap focus when opened in "over" mode',
			fakeAsync(() => {
		...
		it(
			'should trap focus when opened in "push" mode',
			fakeAsync(() => {
		...
		it(
			'should not trap focus when opened in "side" mode',
			fakeAsync(() => {
		...
		it(
			'should focus the drawer if there are no focusable elements',
			fakeAsync(() => {
				fixture.destroy();
...
describe('MatDrawerContainer', () => {
	...
	it(
		'should be able to open and close all drawers',
		fakeAsync(() => {
	...
	it(
		'should animate the content when a drawer is added at a later point',
		fakeAsync(() => {
	...
	it(
		'should recalculate the margin if a drawer is destroyed',
		fakeAsync(() => {
	...
	it(
		'should recalculate the margin if the drawer mode is changed',
		fakeAsync(() => {
			const fixture = TestBed.createComponent(DrawerContainerStateChangesTestApp);
	...
	it(
		'should recalculate the margin if the direction has changed',
		fakeAsync(() => {
			const fixture = TestBed.createComponent(DrawerContainerStateChangesTestApp);
	...
	it(
		'should not animate when the sidenav is open on load ',
		fakeAsync(() => {
	...
	it(
		'should recalculate the margin if a drawer changes size while open in autosize mode',
		fakeAsync(() => {
