...
export const MAT_DRAWER_DEFAULT_AUTOSIZE = new InjectionToken<boolean>('MAT_DRAWER_DEFAULT_AUTOSIZE');
...
export class MatDrawerContainer implements AfterContentInit, OnDestroy {
	...
	_isShowingBackdrop(): boolean {
		return (
			(this._isDrawerOpen(this._start) && this._start!.mode != 'side') ||
