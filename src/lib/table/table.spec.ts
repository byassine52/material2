...
describe('MatTable', () => {
	...
	describe('with MatTableDataSource', () => {
		...
		it(
			'should be able to filter the table contents',
			fakeAsync(() => {
				...
				expectTableToMatchContent(tableElement, [['Column A', 'Column B', 'Column C'], ['a_1', 'b_1', 'c_1']]);
				...
				expectTableToMatchContent(tableElement, [['Column A', 'Column B', 'Column C'], ['a_2', 'b_2', 'c_2']]);
		...
		it(
			'should be able to page the table contents',
			fakeAsync(() => {
