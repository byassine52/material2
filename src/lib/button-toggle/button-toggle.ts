...
export class MatButtonToggleGroup extends _MatButtonToggleGroupMixinBase implements ControlValueAccessor, CanDisable {
	...
	@Output() readonly change: EventEmitter<MatButtonToggleChange> = new EventEmitter<MatButtonToggleChange>();
...
export class MatButtonToggleGroupMultiple extends _MatButtonToggleGroupMixinBase implements CanDisable {
	/** Whether the button toggle group should be vertical. */
	private _vertical: boolean = false;
...
export class MatButtonToggle implements OnInit, OnDestroy {
	...
	get disabled(): boolean {
		return (
			this._disabled ||
			(this.buttonToggleGroup != null && this.buttonToggleGroup.disabled) ||
	...
	constructor(
		@Optional() toggleGroup: MatButtonToggleGroup,
		...
		if (this.buttonToggleGroup) {
			this._removeUniqueSelectionListener = _buttonToggleDispatcher.listen((id: string, name: string) => {
