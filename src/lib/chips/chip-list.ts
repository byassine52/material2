...
export class MatChipList extends _MatChipListMixinBase
	...
	get focused(): boolean {
		return this.chips.some(chip => chip._hasFocus) || (this._chipInput && this._chipInput.focused);
	}
	...
	@Output() readonly change: EventEmitter<MatChipListChange> = new EventEmitter<MatChipListChange>();
