...
export const _MatSelectionListMixinBase = mixinTabIndex(mixinDisableRipple(mixinDisabled(MatSelectionListBase)));
...
export class MatListOption extends _MatListOptionMixinBase
	 ...
	 * @deletion-target 6.0.0
	 */
	@Output() readonly selectionChange: EventEmitter<MatListOptionChange> = new EventEmitter<MatListOptionChange>();
...
export class MatSelectionList extends _MatSelectionListMixinBase
	...
	/** Emits a change event whenever the selected state of an option changes. */
	@Output() readonly selectionChange: EventEmitter<MatSelectionListChange> = new EventEmitter<MatSelectionListChange>();
