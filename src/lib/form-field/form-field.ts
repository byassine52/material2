...
export class MatFormField extends _MatFormFieldMixinBase
	 ...
	 */
	@Input()
	get dividerColor(): ThemePalette {
		return this.color;
	}
	set dividerColor(value: ThemePalette) {
		this.color = value;
	}
	 ...
	 */
	@Input()
	get floatPlaceholder(): FloatLabelType {
	...
	_shouldLabelFloat() {
		return (
			this._canLabelFloat &&
			(this._control.shouldLabelFloat || this._control.shouldPlaceholderFloat || this._shouldAlwaysFloat)
		);
	}
	...
	private _syncDescribedByIds() {
		if (this._control) {
			...
			if (this._getDisplayedMessages() === 'hint') {
				let startHint = this._hintChildren ? this._hintChildren.find(hint => hint.align === 'start') : null;
				let endHint = this._hintChildren ? this._hintChildren.find(hint => hint.align === 'end') : null;
