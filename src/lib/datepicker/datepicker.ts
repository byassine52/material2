...
/** @docs-private */
export function MAT_DATEPICKER_SCROLL_STRATEGY_PROVIDER_FACTORY(overlay: Overlay): () => RepositionScrollStrategy {
...
export class MatDatepicker<D> implements OnDestroy {
	...
	private _openAsPopup(): void {
		...
		if (!this._popupRef.hasAttached()) {
			let componentRef: ComponentRef<MatDatepickerContent<D>> = this._popupRef.attach(this._calendarPortal);
