...
/** @docs-private */
export function MAT_AUTOCOMPLETE_SCROLL_STRATEGY_PROVIDER_FACTORY(overlay: Overlay): () => ScrollStrategy {
...
export class MatAutocompleteTrigger implements ControlValueAccessor, OnDestroy {
	...
	get panelClosingActions(): Observable<MatOptionSelectionChange> {
		return merge(
			...
			this._overlayRef ? this._overlayRef.detachments().pipe(filter(() => this._panelOpen)) : observableOf()
		);
	}
	...
	private _scrollToOption(): void {
		...
		const labelCount = MatOption.countGroupLabelsBeforeOption(
			activeOptionIndex,
