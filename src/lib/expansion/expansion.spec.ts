...
describe('MatExpansionPanel', () => {
	...
	it(
		'should be able to render panel content lazily',
		fakeAsync(() => {
	...
	it(
		'should render the content for a lazy-loaded panel that is opened on init',
		fakeAsync(() => {
	...
	it(
		'should not be able to focus content while closed',
		fakeAsync(() => {
			const fixture = TestBed.createComponent(PanelWithContent);
			fixture.componentInstance.expanded = true;
			fixture.detectChanges();
	...
	it(
		'should not override the panel margin if it is not inside an accordion',
		fakeAsync(() => {
	...
	it('should be able to hide the toggle', () => {
		...
		expect(header.querySelector('.mat-expansion-indicator')).toBeTruthy('Expected indicator to be shown.');

		fixture.componentInstance.hideToggle = true;
		fixture.detectChanges();

		expect(header.querySelector('.mat-expansion-indicator')).toBeFalsy('Expected indicator to be hidden.');
	});

	it(
		'should update the indicator rotation when the expanded state is toggled programmatically',
		fakeAsync(() => {
			const fixture = TestBed.createComponent(PanelWithContent);
