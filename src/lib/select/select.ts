...
/** @docs-private */
export function MAT_SELECT_SCROLL_STRATEGY_PROVIDER_FACTORY(overlay: Overlay): () => RepositionScrollStrategy {
...
export const _MatSelectMixinBase = mixinDisableRipple(mixinTabIndex(mixinDisabled(mixinErrorState(MatSelectBase))));
...
export class MatSelect extends _MatSelectMixinBase
	...
	private _scrollActiveOptionIntoView(): void {
		...
		const labelCount = MatOption.countGroupLabelsBeforeOption(activeOptionIndex, this.options, this.optionGroups);
		...
		if (scrollOffset < panelTop) {
			...
			this.panel.nativeElement.scrollTop = Math.max(0, scrollOffset - SELECT_PANEL_MAX_HEIGHT + itemHeight);
		}
	}
	...
	private _calculateOverlayPosition(): void {
		...
		selectedOptionOffset += MatOption.countGroupLabelsBeforeOption(
