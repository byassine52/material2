...
import { DOWN_ARROW, END, ENTER, HOME, SPACE, TAB, UP_ARROW, LEFT_ARROW, RIGHT_ARROW } from '@angular/cdk/keycodes';
...
describe('MatSelect', () => {
	...
	function configureMatSelectTestingModule(declarations) {
		TestBed.configureTestingModule({
			imports: [MatFormFieldModule, MatSelectModule, ReactiveFormsModule, FormsModule, NoopAnimationsModule],
	...
	describe('core', () => {
		beforeEach(
			async(() => {
				configureMatSelectTestingModule([BasicSelect, MultiSelect, SelectWithGroups]);
			})
		);
		...
		describe('accessibility', () => {
			describe('for select', () => {
				...
				it(
					'should set the role of the select to listbox',
					fakeAsync(() => {
				...
				it(
					'should set the aria label of the select to the placeholder',
					fakeAsync(() => {
				...
				it(
					'should not set an aria-label if aria-labelledby is specified',
					fakeAsync(() => {
				...
				it(
					'should not have aria-labelledby in the DOM if it`s not specified',
					fakeAsync(() => {
						fixture.detectChanges();
				...
				it(
					'should set the tabindex of the select to 0 by default',
					fakeAsync(() => {
				...
				it(
					'should be able to override the tabindex',
					fakeAsync(() => {
				...
				it(
					'should set aria-required for required selects',
					fakeAsync(() => {
				...
				it(
					'should set the mat-select-required class for required selects',
					fakeAsync(() => {
						...
						expect(select.classList).toContain(
							'mat-select-required',
							`Expected the mat-select-required class to be set.`
						);
					})
				);

				it(
					'should set aria-invalid for selects that are invalid and touched',
					fakeAsync(() => {
				...
				it(
					'should set the tabindex of the select to -1 if disabled',
					fakeAsync(() => {
						fixture.componentInstance.control.disable();
						fixture.detectChanges();
				...
				it(
					'should select options via the UP/DOWN arrow keys on a closed select',
					fakeAsync(() => {
				...
				it(
					'should select options via LEFT/RIGHT arrow keys on a closed select',
					fakeAsync(() => {
						const formControl = fixture.componentInstance.control;
						const options = fixture.componentInstance.options.toArray();
				...
				it(
					'should open a single-selection select using ALT + DOWN_ARROW',
					fakeAsync(() => {
				...
				it(
					'should open a single-selection select using ALT + UP_ARROW',
					fakeAsync(() => {
						const { control: formControl, select: selectInstance } = fixture.componentInstance;
				...
				it(
					'should should close when pressing ALT + DOWN_ARROW',
					fakeAsync(() => {
				...
				it(
					'should should close when pressing ALT + UP_ARROW',
					fakeAsync(() => {
						const { select: selectInstance } = fixture.componentInstance;
				...
				it(
					'should be able to select options by typing on a closed select',
					fakeAsync(() => {
						const formControl = fixture.componentInstance.control;
						const options = fixture.componentInstance.options.toArray();
				...
				it(
					'should do nothing when typing on a closed multi-select',
					fakeAsync(() => {
						fixture.destroy();
				...
				it(
					'should do nothing if the key manager did not change the active item',
					fakeAsync(() => {
						const formControl = fixture.componentInstance.control;
				...
				it(
					...
					fakeAsync(() => {
						...
						expect(document.activeElement).toBe(options[3], 'Expected fourth option to remain focused.');
					})
				);

				it(
					'should not cycle through the options if the control is disabled',
					fakeAsync(() => {
						const formControl = fixture.componentInstance.control;
				...
				it(
					'should not wrap selection after reaching the end of the options',
					fakeAsync(() => {
				...
				it(
					'should not open a multiple select when tabbing through',
					fakeAsync(() => {
						fixture.destroy();
						...
						expect(multiFixture.componentInstance.select.panelOpen).toBe(false, 'Expected panel to stay closed.');
					})
				);

				it(
					'should toggle the next option when pressing shift + DOWN_ARROW on a multi-select',
					fakeAsync(() => {
						fixture.destroy();
				...
				it(
					'should toggle the previous option when pressing shift + UP_ARROW on a multi-select',
					fakeAsync(() => {
						fixture.destroy();
				...
				it(
					'should prevent the default action when pressing space',
					fakeAsync(() => {
				...
				it(
					'should consider the selection a result of a user action when closed',
					fakeAsync(() => {
				...
				it(
					'should be able to focus the select trigger',
					fakeAsync(() => {
				...
				it(
					'should set aria-hidden on the trigger element',
					fakeAsync(() => {
				...
				it(
					'should set `aria-multiselectable` to true on multi-select instances',
					fakeAsync(() => {
						fixture.destroy();
				...
				it(
					'should set aria-multiselectable false on single-selection instances',
					fakeAsync(() => {
				...
				it(
					'should set aria-activedescendant only while the panel is open',
					fakeAsync(() => {
				...
				it(
					'should set aria-activedescendant based on the focused option',
					fakeAsync(() => {
						const host = fixture.debugElement.query(By.css('mat-select')).nativeElement;
				...
				it(
					'should not change the aria-activedescendant using the horizontal arrow keys',
					fakeAsync(() => {
						const host = fixture.debugElement.query(By.css('mat-select')).nativeElement;
			...
			describe('for options', () => {
				...
				it(
					'should set the role of mat-option to option',
					fakeAsync(() => {
				...
				it(
					'should set aria-selected on each option',
					fakeAsync(() => {
				...
				it(
					'should set the tabindex of each option according to disabled state',
					fakeAsync(() => {
				...
				it(
					'should set aria-disabled for disabled options',
					fakeAsync(() => {
			...
			describe('for option groups', () => {
				...
				beforeEach(
					fakeAsync(() => {
						...
						trigger.click();
						fixture.detectChanges();
						groups = overlayContainerElement.querySelectorAll('mat-optgroup') as NodeListOf<HTMLElement>;
					})
				);

				it(
					'should set the appropriate role',
					fakeAsync(() => {
				...
				it(
					'should set the `aria-labelledby` attribute',
					fakeAsync(() => {
						let group = groups[0];
				...
				it(
					'should set the `aria-disabled` attribute if the group is disabled',
					fakeAsync(() => {
		...
		describe('overlay panel', () => {
			...
			it(
				'should close the panel when an item is clicked',
				fakeAsync(() => {
					trigger.click();
					fixture.detectChanges();
					flush();
			...
			it(
				'should set the width of the overlay based on the trigger',
				fakeAsync(() => {
			...
			it(
				'should not attempt to open a select that does not have any options',
				fakeAsync(() => {
			...
			it(
				'should close the panel when tabbing out',
				fakeAsync(() => {
					trigger.click();
					fixture.detectChanges();
					flush();
			...
			it(
				'should close when tabbing out from inside the panel',
				fakeAsync(() => {
					trigger.click();
					fixture.detectChanges();
					flush();
			...
			it(
				'should focus the first option when pressing HOME',
				fakeAsync(() => {
			...
			it(
				'should focus the last option when pressing END',
				fakeAsync(() => {
					fixture.componentInstance.control.setValue('pizza-1');
					fixture.detectChanges();
			...
			it(
				'should be able to set extra classes on the panel',
				fakeAsync(() => {
					trigger.click();
					fixture.detectChanges();
			...
			it(
				'should prevent the default action when pressing SPACE on an option',
				fakeAsync(() => {
					trigger.click();
					fixture.detectChanges();
			...
			it(
				'should prevent the default action when pressing ENTER on an option',
				fakeAsync(() => {
					trigger.click();
					fixture.detectChanges();
			...
			it(
				'should update disableRipple properly on each option',
				fakeAsync(() => {
					const options = fixture.componentInstance.options.toArray();
			...
			it(
				'should not show ripples if they were disabled',
				fakeAsync(() => {
					fixture.componentInstance.disableRipple = true;
					fixture.detectChanges();
		...
		describe('selection logic', () => {
			...
			it(
				'should not float label if no option is selected',
				fakeAsync(() => {
					expect(formField.classList.contains('mat-form-field-should-float')).toBe(
						false,
			...
			it(
				'should focus the first option if no option is selected',
				fakeAsync(() => {
					trigger.click();
					fixture.detectChanges();
					flush();
			...
			it(
				'should select an option when it is clicked',
				fakeAsync(() => {
					trigger.click();
					fixture.detectChanges();
					flush();
			...
			it(
				'should deselect other options when one is selected',
				fakeAsync(() => {
					trigger.click();
					fixture.detectChanges();
					flush();
			...
			it(
				'should deselect other options when one is programmatically selected',
				fakeAsync(() => {
			...
			it(
				'should remove selection if option has been removed',
				fakeAsync(() => {
			...
			it(
				'should display the selected option in the trigger',
				fakeAsync(() => {
					trigger.click();
					fixture.detectChanges();
					flush();
					...
					expect(formField.classList.contains('mat-form-field-should-float')).toBe(true, 'Label should be floating');
					expect(value.textContent).toContain('Steak');
				})
			);

			it(
				'should focus the selected option if an option is selected',
				fakeAsync(() => {
			...
			it(
				'should select an option that was added after initialization',
				fakeAsync(() => {
			...
			it(
				'should update the trigger when the selected option label is changed',
				fakeAsync(() => {
					fixture.componentInstance.control.setValue('pizza-1');
					fixture.detectChanges();
			...
			it(
				'should not select options inside a disabled group',
				fakeAsync(() => {
					fixture.destroy();
			...
			it(
				'should not throw if triggerValue accessed with no selected value',
				fakeAsync(() => {
			...
			it(
				'should emit to `optionSelectionChanges` when an option is selected',
				fakeAsync(() => {
					trigger.click();
					fixture.detectChanges();
					flush();
			...
			it(
				'should handle accessing `optionSelectionChanges` before the options are initialized',
				fakeAsync(() => {
					fixture.destroy();
					fixture = TestBed.createComponent(BasicSelect);
		...
		describe('forms integration', () => {
			...
			it(
				'should take an initial view value with reactive forms',
				fakeAsync(() => {
			...
			it(
				'should set the view value from the form',
				fakeAsync(() => {
			...
			it(
				'should update the form value when the view changes',
				fakeAsync(() => {
			...
			it(
				'should clear the selection when a nonexistent option value is selected',
				fakeAsync(() => {
					fixture.componentInstance.control.setValue('pizza-1');
					fixture.detectChanges();
					...
					const value = fixture.debugElement.query(By.css('.mat-select-value'));
					expect(value.nativeElement.textContent.trim()).toBe('Food', `Expected trigger to show the placeholder.`);
			...
			it(
				'should clear the selection when the control is reset',
				fakeAsync(() => {
					fixture.componentInstance.control.setValue('pizza-1');
					fixture.detectChanges();
			...
			it(
				'should set the control to touched when the select is blurred',
				fakeAsync(() => {
			...
			it(
				'should set the control to touched when the panel is closed',
				fakeAsync(() => {
			...
			it(
				'should not set touched when a disabled select is touched',
				fakeAsync(() => {
					expect(fixture.componentInstance.control.touched).toBe(
						false,
						'Expected the control to start off as untouched.'
			...
			it(
				'should set the control to dirty when the select value changes in DOM',
				fakeAsync(() => {
			...
			it(
				'should not set the control to dirty when the value changes programmatically',
				fakeAsync(() => {
					expect(fixture.componentInstance.control.dirty).toEqual(false, `Expected control to start out pristine.`);
			...
			it(
				'should set an asterisk after the label if control is required',
				fakeAsync(() => {
					let requiredMarker = fixture.debugElement.query(By.css('.mat-form-field-required-marker'));
					expect(requiredMarker).toBeNull(`Expected label not to have an asterisk, as control was not required.`);

					fixture.componentInstance.isRequired = true;
					fixture.detectChanges();

					requiredMarker = fixture.debugElement.query(By.css('.mat-form-field-required-marker'));
					expect(requiredMarker).not.toBeNull(`Expected label to have an asterisk, as control was required.`);
				})
			);
		});
		...
		describe('disabled behavior', () => {
			it(
				'should disable itself when control is disabled programmatically',
				fakeAsync(() => {
		...
		describe('animations', () => {
			...
			it(
				...
				fakeAsync(() => {
					expect(formField.classList.contains('mat-form-field-should-float')).toBe(
						false,
						'Expected label to initially have a normal position.'
					);
					...
					expect(formField.classList).not.toContain(
						'mat-form-field-should-float',
			...
			it(
				'should add a class to the panel when the menu is done animating',
				fakeAsync(() => {
					trigger.click();
					fixture.detectChanges();
		...
		describe('keyboard scrolling', () => {
			...
			it(
				'should not scroll to options that are completely in the view',
				fakeAsync(() => {
			...
			it(
				'should scroll down to the active option',
				fakeAsync(() => {
					for (let i = 0; i < 15; i++) {
						dispatchKeyboardEvent(host, 'keydown', DOWN_ARROW);
					}
			...
			it(
				'should scroll up to the active option',
				fakeAsync(() => {
			...
			it(
				'should skip option group labels',
				fakeAsync(() => {
					fixture.destroy();
			...
			it(
				'should scroll top the top when pressing HOME',
				fakeAsync(() => {
					for (let i = 0; i < 20; i++) {
						dispatchKeyboardEvent(host, 'keydown', DOWN_ARROW);
						fixture.detectChanges();
			...
			it(
				'should scroll to the bottom of the panel when pressing END',
				fakeAsync(() => {
			...
			it(
				'should scroll to the active option when typing',
				fakeAsync(() => {
					for (let i = 0; i < 15; i++) {
	...
	describe('when initialized without options', () => {
		...
		it(
			'should select the proper option when option list is initialized later',
			fakeAsync(() => {
	...
	describe('with a selectionChange event handler', () => {
		...
		it(
			'should emit an event when the selected option has changed',
			fakeAsync(() => {
				trigger.click();
				fixture.detectChanges();
		...
		it(
			'should not emit multiple change events for the same option',
			fakeAsync(() => {
				trigger.click();
				fixture.detectChanges();
		...
		it(
			'should only emit one event when pressing arrow keys on closed select',
			fakeAsync(() => {
	...
	describe('with ngModel', () => {
		...
		it(
			'should disable itself when control is disabled using the property',
			fakeAsync(() => {
	...
	describe('with multiple mat-select elements in one view', () => {
		...
		it(
			'should remove aria-owns when the options are not visible',
			fakeAsync(() => {
		...
		it(
			'should set the option id properly',
			fakeAsync(() => {
				let firstOptionID = options[0].id;

				expect(options[0].id).toContain('mat-option', `Expected option ID to have the correct prefix.`);
	...
	describe('with floatLabel', () => {
		...
		it(
			...
			fakeAsync(() => {
				...
				expect(formField.classList.contains('mat-form-field-can-float')).toBe(
					false,
					'Floating label should be disabled'
				);
		...
		it(
			'should be able to always float the label',
			fakeAsync(() => {
				...
				expect(formField.classList.contains('mat-form-field-can-float')).toBe(true, 'Label should be able to float');
				expect(formField.classList.contains('mat-form-field-should-float')).toBe(true, 'Label should be floating');
			})
		);

		it(
			'should default to global floating label type',
			fakeAsync(() => {
				fixture.destroy();
	...
	describe('with a sibling component that throws an error', () => {
		beforeEach(async(() => configureMatSelectTestingModule([SelectWithErrorSibling, ThrowsErrorOnInit])));

		it(
			'should not crash the browser when a sibling throws an error on init',
			fakeAsync(() => {
	...
	describe('with tabindex', () => {
		...
		it(
			'should be able to set the tabindex via the native attribute',
			fakeAsync(() => {
	...
	describe('when initially hidden', () => {
		...
		it(
			'should set the width of the overlay if the element was hidden initially',
			fakeAsync(() => {
	...
	describe('with theming', () => {
		...
		it(
			'should transfer the theme to the select panel',
			fakeAsync(() => {
	...
	describe('when invalid inside a form', () => {
		...
		it(
			'should not throw SelectionModel errors in addition to ngModel errors',
			fakeAsync(() => {
	...
	describe('with ngModel using compareWith', () => {
		...
		describe('comparing by value', () => {
			...
			it(
				'should update when making a new selection',
				fakeAsync(() => {
		...
		describe('comparing by reference', () => {
			...
			it(
				'should initialize with no selection despite having a value',
				fakeAsync(() => {
			...
			it(
				'should not update the selection if value is copied on change',
				fakeAsync(() => {
			...
			it(
				'should throw an error when using a non-function comparator',
				fakeAsync(() => {
	...
	describe(`when the select's value is accessed on initialization`, () => {
		...
		it(
			'should not throw when trying to access the selected value on init',
			fakeAsync(() => {
				expect(() => {
	...
	describe('inside of a form group', () => {
		...
		it(
			...
			fakeAsync(() => {
				...
				expect(select.classList).toContain('mat-select-invalid', 'Expected select to appear invalid.');
				expect(select.getAttribute('aria-invalid')).toBe('true', 'Expected aria-invalid to be set to true.');
			})
		);

		it(
			'should not have the invalid class when the select becomes valid',
			fakeAsync(() => {
				testComponent.formControl.markAsTouched();
				fixture.detectChanges();
		...
		it(
			'should appear as invalid when the parent form group is submitted',
			fakeAsync(() => {
				expect(select.classList).not.toContain('mat-select-invalid', 'Expected select not to appear invalid.');
				expect(select.getAttribute('aria-invalid')).toBe('false', 'Expected aria-invalid to be set to false.');
		...
		it(
			'should render the error messages when the parent form is submitted',
			fakeAsync(() => {
		...
		it(
			'should override error matching behavior via injection token',
			fakeAsync(() => {
	...
	describe('with custom error behavior', () => {
		...
		it(
			'should be able to override the error matching behavior via an @Input',
			fakeAsync(() => {
	...
	describe('with preselected array values', () => {
		beforeEach(async(() => configureMatSelectTestingModule([SingleSelectWithPreselectedArrayValues])));

		it(
			'should be able to preselect an array value in single-selection mode',
			fakeAsync(() => {
	...
	describe('with custom value accessor', () => {
		beforeEach(async(() => configureMatSelectTestingModule([CompWithCustomSelect, CustomSelectAccessor])));
	...
	describe('with a falsy value', () => {
		...
		it(
			'should be able to programmatically select a falsy option',
			fakeAsync(() => {
				...
				expect(fixture.componentInstance.options.first.selected).toBe(true, 'Expected first option to be selected');
	...
	describe('with OnPush', () => {
		beforeEach(async(() => configureMatSelectTestingModule([BasicSelectOnPush, BasicSelectOnPushPreselected])));

		it(
			'should set the trigger text based on the value when initialized',
			fakeAsync(() => {
		...
		it(
			'should update the trigger based on the value',
			fakeAsync(() => {
	...
	describe('with custom trigger', () => {
		...
		it(
			'should allow the user to customize the label',
			fakeAsync(() => {
	...
	describe('when reseting the value by setting null or undefined', () => {
		...
		it(
			'should reset when an option with an undefined value is selected',
			fakeAsync(() => {
				options[4].click();
				fixture.detectChanges();
				flush();
		...
		it(
			'should reset when an option with a null value is selected',
			fakeAsync(() => {
				options[5].click();
				fixture.detectChanges();
				flush();
		...
		it(
			'should reset when a blank option is selected',
			fakeAsync(() => {
				options[6].click();
				fixture.detectChanges();
				flush();
		...
		it(
			'should not reset when any other falsy option is selected',
			fakeAsync(() => {
				options[3].click();
				fixture.detectChanges();
				flush();
	...
	describe('without Angular forms', () => {
		...
		it(
			'should set the value when options are clicked',
			fakeAsync(() => {
		...
		it(
			'should mark options as selected when the value is set',
			fakeAsync(() => {
				const fixture = TestBed.createComponent(BasicSelectWithoutForms);
		...
		it(
			'should reset the label when a null value is set',
			fakeAsync(() => {
				const fixture = TestBed.createComponent(BasicSelectWithoutForms);
		...
		it(
			'should reflect the preselected value',
			fakeAsync(() => {
		...
		it(
			'should restore focus to the host element',
			fakeAsync(() => {
				const fixture = TestBed.createComponent(BasicSelectWithoutForms);
		...
		it(
			'should not restore focus to the host element when clicking outside',
			fakeAsync(() => {
				const fixture = TestBed.createComponent(BasicSelectWithoutForms);
				const select = fixture.debugElement.nativeElement.querySelector('mat-select');
		...
		it(
			'should update the data binding before emitting the change event',
			fakeAsync(() => {
				const fixture = TestBed.createComponent(BasicSelectWithoutForms);
				const instance = fixture.componentInstance;
	...
	describe('positioning', () => {
		beforeEach(async(() => configureMatSelectTestingModule([BasicSelect, MultiSelect, SelectWithGroups])));

		beforeEach(
			inject([ViewportRuler], (vr: ViewportRuler) => {
				viewportRuler = vr;
			})
		);
		...
		function checkTriggerAlignedWithOption(index: number, selectInstance = fixture.componentInstance.select): void {
			...
			// deviations.
			expect(Math.abs(topDifference) < 2).toBe(true, `Expected trigger to align with option ${index}.`);
			...
			expect(origin).toBe(expectedOrigin, `Expected panel animation to originate in the center of option ${index}.`);
		}
		...
		describe('ample space to open', () => {
			...
			it(
				...
				fakeAsync(() => {
					...
					expect(Math.floor(scrollContainer.scrollTop)).toBe(
						376,
						`Expected overlay panel to be scrolled to center the selected option.`
					);
		...
		describe('limited space to open vertically', () => {
			...
			it(
				...
				fakeAsync(() => {
					...
					expect(Math.ceil(scrollContainer.scrollTop)).toEqual(
			...
			it(
				...
				fakeAsync(() => {
					...
					const formFieldBottom = bottomMostPositionForPerfectCentering - formFieldBottomSpace - expectedExtraScroll;
					...
					const difference = Math.ceil(scrollContainer.scrollTop) - Math.ceil(idealScrollTop - expectedExtraScroll);
					...
					expect(Math.abs(difference) < 2).toBe(true, `Expected panel to adjust scroll position to fit in viewport.`);
			...
			it(
				...
				fakeAsync(() => {
					...
					expect(Math.abs(difference) < 2).toEqual(true, `Expected trigger bottom to align with overlay bottom.`);

					expect(fixture.componentInstance.select._transformOrigin).toContain(
						`bottom`,
						`Expected panel animation to originate at the bottom.`
					);
				})
			);
			...
			it(
				...
				fakeAsync(() => {
					...
					expect(Math.floor(overlayTop)).toEqual(
						Math.floor(triggerTop),
						`Expected trigger top to align with overlay top.`
					);

					expect(fixture.componentInstance.select._transformOrigin).toContain(
						`top`,
						`Expected panel animation to originate at the top.`
					);
				})
			);
		});
		...
		describe('limited space to open horizontally', () => {
			...
			it(
				...
				fakeAsync(() => {
					...
					const panelRight = document.querySelector('.mat-select-panel')!.getBoundingClientRect().right;

					expect(viewportRect - panelRight).toBeGreaterThan(
						0,
			...
			it(
				...
				fakeAsync(() => {
					...
					expect(panelLeft).toBeGreaterThan(0, `Expected select panel continue being inside the viewport.`);
				})
			);
		});
		...
		describe('x-axis positioning', () => {
			...
			it(
				...
				fakeAsync(() => {
					...
					const firstOptionLeft = document.querySelector('.cdk-overlay-pane mat-option')!.getBoundingClientRect().left;

					// Each option is 32px wider than the trigger, so it must be adjusted 16px
					// to ensure the text overlaps correctly.
					expect(Math.floor(firstOptionLeft)).toEqual(
			...
			it(
				...
				fakeAsync(() => {
					...
					const firstOptionRight = document.querySelector('.cdk-overlay-pane mat-option')!.getBoundingClientRect()
						.right;

					// Each option is 32px wider than the trigger, so it must be adjusted 16px
					// to ensure the text overlaps correctly.
					expect(Math.floor(firstOptionRight)).toEqual(
		...
		describe('x-axis positioning with groups', () => {
			...
			it(
				...
				fakeAsync(() => {
					...
					groupFixture.whenStable().then(() => {
						...
						const triggerLeft = trigger.getBoundingClientRect().left;
						const selectedOptionLeft = group.querySelector('mat-option.mat-selected')!.getBoundingClientRect().left;
			...
			it(
				...
				fakeAsync(() => {
					...
					const group = document.querySelector('.cdk-overlay-pane mat-optgroup')!;
					const triggerRight = trigger.getBoundingClientRect().right;
					const selectedOptionRight = group.querySelector('mat-option.mat-selected')!.getBoundingClientRect().right;

					// 32px is the 16px default padding plus 16px of padding when an option is in a group.
					expect(Math.floor(selectedOptionRight)).toEqual(
			...
			it(
				...
				fakeAsync(() => {
					...
					// not exact.
					if (platform.TRIDENT) {
						let difference = Math.abs(optionTop + (menuItemHeight - triggerHeight) / 2 - triggerTop);
						expect(difference).toBeLessThan(0.1, 'Expected trigger to align with the first option.');
					} else {
						expect(Math.floor(optionTop + (menuItemHeight - triggerHeight) / 2)).toBe(
							Math.floor(triggerTop),
							'Expected trigger to align with the first option.'
						);
					}
				})
			);
	...
	describe('with multiple selection', () => {
		...
		it(
			'should be able to toggle an option on and off',
			fakeAsync(() => {
				trigger.click();
				fixture.detectChanges();
		...
		it(
			'should be able to set the selected value by taking an array',
			fakeAsync(() => {
				trigger.click();
				testInstance.control.setValue(['steak-0', 'eggs-5']);
				fixture.detectChanges();

				const optionNodes = overlayContainerElement.querySelectorAll('mat-option') as NodeListOf<HTMLElement>;
		...
		it(
			'should override the previously-selected value when setting an array',
			fakeAsync(() => {
				trigger.click();
				fixture.detectChanges();
		...
		it(
			'should not close the panel when clicking on options',
			fakeAsync(() => {
				trigger.click();
				fixture.detectChanges();
		...
		it(
			'should sort the selected options based on their order in the panel',
			fakeAsync(() => {
				trigger.click();
				fixture.detectChanges();
				flush();
		...
		it(
			'should sort the selected options in reverse in rtl',
			fakeAsync(() => {
				dir.value = 'rtl';
				trigger.click();
				fixture.detectChanges();
		...
		it(
			'should sort the values that get set via the model based on the panel order',
			fakeAsync(() => {
				trigger.click();
				fixture.detectChanges();
		...
		it(
			'should reverse sort the values, that get set via the model in rtl',
			fakeAsync(() => {
				dir.value = 'rtl';
				trigger.click();
				fixture.detectChanges();
		...
		it(
			'should throw an exception when trying to set a non-array value',
			fakeAsync(() => {
				expect(() => {
		...
		it(
			'should throw an exception when trying to change multiple mode after init',
			fakeAsync(() => {
				expect(() => {
		...
		it(
			'should pass the `multiple` value to all of the option instances',
			fakeAsync(() => {
				trigger.click();
				fixture.detectChanges();
				flush();
		...
		it(
			'should update the active item index on click',
			fakeAsync(() => {
				trigger.click();
				fixture.detectChanges();
				flush();
...
class SelectWithChangeEvent {
	foods: string[] = ['steak-0', 'pizza-1', 'tacos-2', 'sandwich-3', 'chips-4', 'eggs-5', 'pasta-6', 'sushi-7'];
...
class BasicSelectWithoutFormsPreselected {
	...
	foods: any[] = [{ value: 'steak-0', viewValue: 'Steak' }, { value: 'pizza-1', viewValue: 'Pizza' }];
