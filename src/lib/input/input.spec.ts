...
describe('MatInput without forms', () => {
	...
	it(
		'should default to floating labels',
		fakeAsync(() => {
			let fixture = TestBed.createComponent(MatInputWithId);
			fixture.detectChanges();

			let formField = fixture.debugElement.query(By.directive(MatFormField)).componentInstance as MatFormField;
	...
	it(
		...
		fakeAsync(() => {
			...
			let formField = fixture.debugElement.query(By.directive(MatFormField)).componentInstance as MatFormField;
			expect(formField.floatLabel).toBe(
				'always',
	...
	it(
		'should not be treated as empty if type is date',
		fakeAsync(
	...
	it(
		'should be treated as empty if type is date in Safari Desktop or IE',
		fakeAsync(
			inject([Platform], (platform: Platform) => {
				if (platform.TRIDENT || (platform.SAFARI && !platform.IOS)) {
					let fixture = TestBed.createComponent(MatInputDateTestController);
	...
	it(
		'should treat text input type as empty at init',
		fakeAsync(() => {
	...
	it(
		'should treat password input type as empty at init',
		fakeAsync(() => {
	...
	it(
		'should treat number input type as empty at init',
		fakeAsync(() => {
	...
	it(
		'should not be empty when the value set before view init',
		fakeAsync(() => {
	...
	it(
		...
		fakeAsync(() => {
			...
			const labelElement: HTMLInputElement = fixture.debugElement.query(By.css('label')).nativeElement;
	...
	it(
		'should add aria-owns to the label for the associated control',
		fakeAsync(() => {
			let fixture = TestBed.createComponent(MatInputTextTestController);
			fixture.detectChanges();
	...
	it(
		"validates there's only one hint label per side",
		fakeAsync(() => {
	...
	it(
		"validates there's only one hint label per side (attribute)",
		fakeAsync(() => {
	...
	it(
		'validates that matInput child is present',
		fakeAsync(() => {
			let fixture = TestBed.createComponent(MatInputMissingMatInputTestController);

			expect(() => fixture.detectChanges()).toThrowError(wrappedErrorMessage(getMatFormFieldMissingControlError()));
		})
	);

	it(
		'validates that matInput child is present after initialization',
		fakeAsync(() => {
			let fixture = TestBed.createComponent(MatInputWithNgIf);

			expect(() => fixture.detectChanges()).not.toThrowError(wrappedErrorMessage(getMatFormFieldMissingControlError()));
	...
	it(
		'supports hint labels attribute',
		fakeAsync(() => {
	...
	it(
		'sets an id on the hint element',
		fakeAsync(() => {
			let fixture = TestBed.createComponent(MatInputHintLabel2TestController);
	...
	it(
		...
		fakeAsync(() => {
			...
			expect(formFieldEl.classList.contains('mat-form-field-disabled')).toBe(
				false,
	...
	it(
		'sets the aria-describedby when a hintLabel is set',
		fakeAsync(() => {
			let fixture = TestBed.createComponent(MatInputHintLabelTestController);
	...
	it(
		'sets the aria-describedby to the id of the mat-hint',
		fakeAsync(() => {
			let fixture = TestBed.createComponent(MatInputHintLabel2TestController);
	...
	it(
		'sets the aria-describedby with multiple mat-hint instances',
		fakeAsync(() => {
	...
	it(
		'sets the aria-describedby when a hintLabel is set, in addition to a mat-hint',
		fakeAsync(() => {
	...
	it(
		'should float when floatLabel is set to default and text is entered',
		fakeAsync(() => {
	...
	it(
		'should be able to toggle the floating label programmatically',
		fakeAsync(() => {
			...
			expect(label.classList).toContain('mat-form-field-empty', 'Expected input to be considered empty.');

			containerInstance.floatLabel = 'always';
			fixture.detectChanges();

			expect(label.classList).not.toContain('mat-form-field-empty', 'Expected input to be considered not empty.');
		})
	);

	it(
		'should not have prefix and suffix elements when none are specified',
		fakeAsync(() => {
			let fixture = TestBed.createComponent(MatInputWithId);
			fixture.detectChanges();
	...
	it(
		'should add prefix and suffix elements when specified',
		fakeAsync(() => {
	...
	it(
		'should update empty class when value changes programmatically and OnPush',
		fakeAsync(() => {
	...
	it(
		'should set the focused class when the input is focused',
		fakeAsync(() => {
			let fixture = TestBed.createComponent(MatInputTextTestController);
			fixture.detectChanges();
	...
	it(
		'should remove the focused class if the input becomes disabled while focused',
		fakeAsync(() => {
	...
	it(
		...
		fakeAsync(() => {
			...
			let inputContainer = fixture.debugElement.query(By.directive(MatFormField)).componentInstance as MatFormField;
			let label = fixture.debugElement.query(By.css('.mat-form-field-label')).nativeElement;
	...
	it(
		'should not highlight when focusing a readonly input',
		fakeAsync(() => {
...
describe('MatInput with forms', () => {
	...
	describe('error messages', () => {
		...
		it(
			'should not show any errors if the user has not interacted',
			fakeAsync(() => {
		...
		it(
			...
			fakeAsync(() => {
				...
				expect(containerEl.querySelectorAll('mat-error').length).toBe(
					1,
		...
		it(
			...
			fakeAsync(() => {
				...
				expect(containerEl.querySelectorAll('mat-hint').length).toBe(0, 'Expected no hints to be shown.');
				...
				expect(containerEl.querySelectorAll('mat-hint').length).toBe(
					1,
					'Expected one hint to be shown once the input is valid.'
				);
			})
		);

		it(
			'should not hide the hint if there are no error messages',
			fakeAsync(() => {
				testComponent.renderError = false;
				fixture.detectChanges();

				expect(containerEl.querySelectorAll('mat-hint').length).toBe(1, 'Expected one hint to be shown on load.');

				testComponent.formControl.markAsTouched();
				fixture.detectChanges();
				flush();

				expect(containerEl.querySelectorAll('mat-hint').length).toBe(1, 'Expected one hint to still be shown.');
			})
		);

		it(
			'should set the proper role on the error messages',
			fakeAsync(() => {
				testComponent.formControl.markAsTouched();
				fixture.detectChanges();
		...
		it(
			'sets the aria-describedby to reference errors when in error state',
			fakeAsync(() => {
	...
	describe('custom error behavior', () => {
		it(
			'should display an error message when a custom error matcher returns true',
			fakeAsync(() => {
				...
				expect(containerEl.querySelectorAll('mat-error').length).toBe(0, 'Expected no error messages');
		...
		it(
			'should display an error message when global error matcher returns true',
			fakeAsync(() => {
				TestBed.resetTestingModule();
				TestBed.configureTestingModule({
					imports: [FormsModule, MatFormFieldModule, MatInputModule, NoopAnimationsModule, ReactiveFormsModule],
					declarations: [MatInputWithFormErrorMessages],
		...
		it(
			'should display an error message when using ShowOnDirtyErrorStateMatcher',
			fakeAsync(() => {
				TestBed.resetTestingModule();
				TestBed.configureTestingModule({
					imports: [FormsModule, MatFormFieldModule, MatInputModule, NoopAnimationsModule, ReactiveFormsModule],
				...
				expect(containerEl.querySelectorAll('mat-error').length).toBe(0, 'Expected no error messages when touched');

				testComponent.formControl.markAsDirty();
				fixture.detectChanges();

				expect(containerEl.querySelectorAll('mat-error').length).toBe(1, 'Expected one error message when dirty');
			})
		);
	});
