...
describe('MomentDateAdapter', () => {
	...
	beforeEach(
		inject([DateAdapter], (dateAdapter: MomentDateAdapter) => {
			moment.locale('en');
			adapter = dateAdapter;
	...
	it("should get today's date", () => {
		expect(adapter.sameDate(adapter.today(), moment())).toBe(true, "should be equal to today's date");
	});
...
describe('MomentDateAdapter with MAT_DATE_LOCALE override', () => {
	...
	beforeEach(
		inject([DateAdapter], (d: MomentDateAdapter) => {
			adapter = d;
		})
	);
