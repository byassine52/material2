...
import { TemplateRef, SkipSelf, Optional, Injector, Inject, ComponentRef } from '@angular/core';
...
import { ComponentType, Overlay, OverlayRef, OverlayConfig } from '@angular/cdk/overlay';
...
export class Dialog {
	...
	protected _attachDialogContentForComponent<T>(
		...
		dialogRef.updateSize({ width: config.width, height: config.height }).updatePosition(config.position);
