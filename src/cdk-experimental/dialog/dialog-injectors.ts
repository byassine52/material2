...
export const DIALOG_CONTAINER = new InjectionToken<ComponentType<CdkDialogContainer>>('DialogContainer');

/** @docs-private */
export function MAT_DIALOG_SCROLL_STRATEGY_PROVIDER_FACTORY(overlay: Overlay): () => BlockScrollStrategy {
