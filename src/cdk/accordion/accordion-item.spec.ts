...
describe('CdkAccordionItem', () => {
	...
	describe('single item', () => {
		...
		beforeEach(() => {
			...
			item = fixture.debugElement.query(By.directive(CdkAccordionItem)).injector.get(CdkAccordionItem);
		});
	...
	describe('items without accordion', () => {
		...
		beforeEach(() => {
			...
			[firstItem, secondItem] = fixture.debugElement.queryAll(By.directive(CdkAccordionItem)).map(el => {
