...
describe('LiveAnnouncer', () => {
	...
	describe('with default element', () => {
		...
		it(
			'should correctly update the announce text',
			fakeAsync(() => {
		...
		it(
			'should correctly update the politeness attribute',
			fakeAsync(() => {
		...
		it(
			'should apply the aria-live value polite by default',
			fakeAsync(() => {
		...
		it(
			'should remove the aria-live element from the DOM on destroy',
			fakeAsync(() => {
				announcer.announce('Hey Google');
				...
				expect(document.body.querySelector('[aria-live]')).toBeFalsy(
	...
	describe('with a custom element', () => {
		...
		it(
			'should allow to use a custom live element',
			fakeAsync(() => {
