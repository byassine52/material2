...
export class OverlayKeyboardDispatcher implements OnDestroy {
	...
	private _subscribeToKeydownEvents(): void {
		...
		this._keydownEventSubscription = bodyKeydownEvents
			.pipe(filter(() => !!this._attachedOverlays.length))
			.subscribe(event => {
...
/** @docs-private */
export function OVERLAY_KEYBOARD_DISPATCHER_PROVIDER_FACTORY(dispatcher: OverlayKeyboardDispatcher, _document: any) {
