...
export class CdkConnectedOverlay implements OnDestroy, OnChanges {
	...
	@Input('cdkConnectedOverlayScrollStrategy') scrollStrategy: ScrollStrategy = this._scrollStrategy();
	 ...
	 */
	@Input('origin')
	get _deprecatedOrigin(): CdkOverlayOrigin {
		return this.origin;
	}
	set _deprecatedOrigin(_origin: CdkOverlayOrigin) {
		this.origin = _origin;
	}
	...
	set _deprecatedPositions(_positions: ConnectionPositionPair[]) {
	 ...
	 */
	@Input('offsetX')
	get _deprecatedOffsetX(): number {
		return this.offsetX;
	}
	set _deprecatedOffsetX(_offsetX: number) {
	 ...
	 */
	@Input('offsetY')
	get _deprecatedOffsetY(): number {
		return this.offsetY;
	}
	set _deprecatedOffsetY(_offsetY: number) {
	 ...
	 */
	@Input('width')
	get _deprecatedWidth(): number | string {
		return this.width;
	}
	set _deprecatedWidth(_width: number | string) {
		this.width = _width;
	}
	 ...
	 */
	@Input('height')
	get _deprecatedHeight(): number | string {
		return this.height;
	}
	set _deprecatedHeight(_height: number | string) {
		this.height = _height;
	}
	 ...
	 */
	@Input('minWidth')
	get _deprecatedMinWidth(): number | string {
	 ...
	 */
	@Input('minHeight')
	get _deprecatedMinHeight(): number | string {
		return this.minHeight;
	}
	set _deprecatedMinHeight(_minHeight: number | string) {
	 ...
	 */
	@Input('backdropClass')
	get _deprecatedBackdropClass(): string {
	...
	get _deprecatedScrollStrategy(): ScrollStrategy {
	...
	private _createPositionStrategy(): ConnectedPositionStrategy {
		...
		this._positionSubscription = strategy.onPositionChange.subscribe(pos => this.positionChange.emit(pos));
