...
describe('MediaMatcher', () => {
	...
	beforeEach(
		inject([BreakpointObserver, MediaMatcher], (bm: BreakpointObserver, mm: MediaMatcher) => {
	...
	it(
		'adds css rules for provided queries when the platform is webkit, otherwise adds nothing.',
