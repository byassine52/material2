...
describe('Directionality', () => {
	...
	describe('Dir directive', () => {
		it('should provide itself as Directionality', () => {
			...
			const injectedDirectionality = fixture.debugElement.query(By.directive(InjectsDirectionality)).componentInstance
				.dir;
		...
		it(
			'should complete the change stream on destroy',
			fakeAsync(() => {
				const fixture = TestBed.createComponent(ElementWithDir);
				const dir = fixture.debugElement.query(By.directive(InjectsDirectionality)).componentInstance.dir;
